    ...
    return (
        <section className="relative flex flex-col items-center min-h-[85vh] bg-gray-100 overflow-hidden px-10 py-20">
            ...
            <div className="flex justify-center gap-28 w-full max-w-7xl">
                ...
                {/* Contact Info Column */}
                <div className="flex flex-col space-y-8 text-black pt-10 w-1/2 max-w-md">
                ...
                <div className="flex flex-col space-y-10 text-black pt-10 w-1/2 max-w-md">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            className="bg-gray-100 border-gray-300 border-[1px] rounded-md h-[37px] w-full px-3"
                    ...
                    <div>
                        ...
                        <textarea
                            className="bg-gray-100 border-gray-300 border-[1px] rounded-md h-[150px] w-full p-3 resize-none"
